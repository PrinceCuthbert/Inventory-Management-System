...
const fetchProducts = async () => {
    ...
    return [
        ...
        },
        {
            ...
            unit: "piece",
            description: "LED headlight bulbs compatible with multiple vehicle brands",
            is_active: true,
...
function Products() {
    ...
    // get (use query), (put, patch, delete, post) --> use mutation
    ...
    const getProductStats = (product) => {
        ...
        const lowStockVariants = product.variants.filter(variant => variant.stock <= variant.min_stock_level);
                                ...
                                <tr key={product.id}>
                                    ...
                                    <td data-label="Variants">
                                        <Badge variant="outline" className="variants-count">
                                            {stats.totalVariants} variant{stats.totalVariants !== 1 ? 's' : ''}
                                        </Badge>
                                    </td>
                                    <td data-label="Stock Status">
                                        <div className="stock-info">
                                            <span className="stock-count">{stats.totalStock} units</span>
                                            {stats.hasLowStock && (
                                                <Badge variant="destructive" className="low-stock-badge">
                                    ...
                                    <td data-label="Supplier">{product.default_supplier.name}</td>
                                        ...
                                        {selectedProduct.variants.map((variant) => (
                                            <div key={variant.id} className="variant-item">
                                                <div className="variant-header">
                                                    <span className="variant-code">{variant.variant_code}</span>
                                                ...
                                                <div className="variant-details">
                                                    ...
                                                    <span>Stock: {variant.stock} / Min: {variant.min_stock_level}</span>
                                                </div>
