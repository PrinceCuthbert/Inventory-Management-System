...
const fetchBrands = async () => {
  ...
  return [
    ...
    { id: 3, name: "Nissan", description: "Nissan genuine parts" },
    {
      id: 4,
      name: "Mercedes-Benz",
      description: "Mercedes-Benz genuine parts",
    },
    ...
    const productData = {
      ...
      variants: variants.map((variant) => ({
        ...
        min_stock_level: variant.min_stock_level
          ? parseFloat(variant.min_stock_level)
          : 0,
      })),
    };
          ...
          <CardContent>
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                {errors.brand_id && (
                  <span className="error-text">{errors.brand_id}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("default_supplier_id", value)
                  }>
                  <SelectTrigger
                    className={errors.default_supplier_id ? "error" : ""}>
